...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tkkmig8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tkkmig8.containers.anotherwebservice.com/
...
```
git clone git@github.com:ellisonsparks2-pixel/container-tkkmig8.git
cd container-tkkmig8
```
...
```
docker attach container-tkkmig8
```
